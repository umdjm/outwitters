...
MapEditor.Hexagon = function(id, x, y) {
    ...
    this.movedImage.style.backgroundColor = "white";
    ...
    this.attackedImage.style.backgroundColor = "white";
...
MapEditor.Hexagon.prototype.updateImage = function() {
    ...
    if(this.isUnitPlaceable()) {
        if(this.unitClass != "") {
            ...
            if(!this.isValidHealth(current.health)) {
...
MapEditor.Hexagon.prototype.isValidHealth = function(input) {
    if(input == "health1" || input == "health2" || input == "health3" || input == "health4" || input == "health5")
        return true;
    return false;
}
MapEditor.Hexagon.prototype.getDefaultHealth = function() {
    if(this.getUnitType() == "") return "health3";
    var unitType = MapEditor.Config[this.getUnitType()];
...
MapEditor.Hexagon.prototype.draw = function(ctx) {
    ...
    if(this.isUnitPlaceable() && this.unitClass != "") {
        ...
        if(this.hasMoved) ctx.drawImage(this.movedImage, this.TopLeftPoint.X + 30, this.TopLeftPoint.Y - 10, this.movedImage.width, this.movedImage.height)
        if(this.hasAttacked) ctx.drawImage(this.attackedImage, this.TopLeftPoint.X + 30, this.TopLeftPoint.Y + 10, this.attackedImage.width, this.attackedImage.height);
    }
